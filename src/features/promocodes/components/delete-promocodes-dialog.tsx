...
import { Promocode, useBulkDeletePromocodes } from '@/features/promocodes';
...
export function DeletePromocodesDialog({ rows }: Props) {
  const t = useTranslations('promocodes');
  const deleteMutation = useBulkDeletePromocodes();
