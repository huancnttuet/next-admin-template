...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        `absolute inset-y-0 z-20 hidden w-2 -translate-x-1/2 transition-all
        ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px]
        hover:after:bg-sidebar-border group-data-[side=left]:-right-2
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        `scrollbar-thin flex min-h-0 flex-1 flex-col gap-2 overflow-auto
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        [&>svg]:shrink-0 [&>svg]:text-sidebar-foreground`,
        `data-[active=true]:bg-sidebar-accent
        data-[active=true]:text-sidebar-accent-foreground
        [&>svg]:hover:text-sidebar-accent-foreground
