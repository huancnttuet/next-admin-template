...
const SCALE_OPTIONS = [
  ...
  { label: <Ban />, value: 'normal' as ScaleKey },
  { label: 'LG', value: 'lg' as ScaleKey },
] as const;

const RADIUS_OPTIONS = [
  { label: 'SM', value: 'sm' as RadiusKey },
  { label: <Ban />, value: 'normal' as RadiusKey },
          ...
          <div className='space-y-3'>
                  ...
                  {THEME_PRESETS.map((preset) => (
                    ...
                    >
                      <span className='flex items-center gap-2'>
                        <span
                          className={cn('size-2.5 rounded-full', preset.color)}
                        />
                        {preset.label}
                      </span>
                    </SelectItem>
            ...
            <div className='space-y-1'>
              ...
              <ToggleGroup
                ...
                onValueChange={(v) =>
                  v && setSidebarVariant(v as SidebarVariant)
                }
              >
                <ToggleGroupItem
                  value='inset'
